                    ...
                    <div class="toggle-expand-content" data-content="pageMenu">
                        <ul class="nk-block-tools g-3">
                            <li class="nk-block-tools-opt">
                                <a href="{{ route('company.create') }}" class="btn btn-primary" ajax-modal>
    ...
    <div class="nk-block">
        <div class="card card-bordered card-stretch">
            <div class="card-inner-group">
                ...
                @endif
                    <table id="company-dt" class="table nowrap nk-tb-list nk-tb-ulist dataTable no-footer" width="100%">
                        <thead>
...
@push('scripts')
    <script>
        var table = $('#company-dt').DataTable({
            processing: true,
            serverSide: true,
            scrollX: false,
            ordering: false,
            autoWidth: true,
            ajax: "{{ route('company-dt') }}",
            columns: [{
                    data: 'DT_RowIndex',
                    name: 'uuid',
                    orderable: false,
