                                            ...
                                            <div class="simplebar-content-wrapper" tabindex="0" role="region" aria-label="scrollable content"
                                                            ...
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <ul class="link-list-opt no-bdr">
                                                                        <li>
                                                                            <a href="{{ route('profile.avatar.edit') }}" ajax-modal data-method="post">
                                                ...
                                                <div class="card-inner p-0">
                                                    <ul class="link-list-menu">
                                                        ...
                                                        <li>
                                                            <a href="{{ route('profile.password.edit') }}" ajax-modal data-method="post">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="personal-tab">
                                    ...
                                    <div class="nk-data data-list">
                                        <a href="{{ route('profile.edit') }}" class="data-item" ajax-modal data-method="post">
                                            <div class="data-col">
                                        ...
                                        <a href="{{ route('profile.edit') }}" class="data-item" ajax-modal data-method="post">
                                            <div class="data-col">
                                                ...
                                                <span id="phone" class="data-value text-soft">{!! canEmpty(auth()->user()->phone) !!}</span>
                                            </div>
                                            <div class="data-col data-col-end">
                                                <span class="data-more">
                                                    <em class="icon ni ni-forward-ios"></em>
                                        ...
                                        <a href="{{ route('profile.edit') }}" class="data-item" ajax-modal data-method="post">
                                            <div class="data-col">
                                                <span class="data-label">Alternate Phone Number</span>
                                                <span id="alt_phone" class="data-value text-soft">{!! canEmpty(auth()->user()->alt_phone) !!}</span>
                                            </div>
                                            <div class="data-col data-col-end">
                                                <span class="data-more">
                                                    <em class="icon ni ni-forward-ios"></em>
...
@push('scripts')
    <script>
        $(document).on('profile.updated', function(e, url, params) {
        ...
        $(document).on('avatar.updated', function(e, url, params) {
