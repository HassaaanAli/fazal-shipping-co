<!-- sidebar @s -->
<div class="nk-sidebar nk-sidebar-fixed is-dark {{ $isCompactSidebar ? 'is-compact' : '' }}" data-content="sidebarMenu">
    <div class="nk-sidebar-element nk-sidebar-head">
        <div class="nk-menu-trigger">
            <a href="javascript:void(0);" class="nk-nav-toggle nk-quick-nav-icon d-xl-none" data-target="sidebarMenu">
                <em class="icon ni ni-arrow-left"></em>
            </a>
            <a href="javascript:void(0);" class="nk-nav-compact nk-quick-nav-icon d-none d-xl-inline-flex {{ $isCompactSidebar ? 'compact-active' : '' }}"
                data-target="sidebarMenu" id="toggle-sidebar" data-url="{{ route('settings.store') }}" data-value="{{ !$isCompactSidebar }}">
